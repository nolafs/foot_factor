    ...
    <main className="overflow-hidden">
      ...
      <Container>
        ...
        <Heading as="h1" className="mt-2">
          What’s happening at FootFactor.
        </Heading>
        <Lead className="mt-6 max-w-3xl">
          Say goodbye to pain and hello to freedom of movement. Foot Factor’s team of experts provides full-spectrum
          care to restore your comfort, confidence, and performance
        </Lead>
      </Container>
