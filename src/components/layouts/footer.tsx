          ...
          <Container className={'relative z-10 block pb-10'}>
            <div className="mt-10 grid grid-cols-2 gap-y-10 pb-10 lg:grid-cols-6 lg:gap-8">
              <div className="col-span-2 flex flex-col space-y-10">
                ...
                <div className={'space-y-5 pl-3 text-secondary'}>
                  <div>
                          ...
                          <>
                            <div className={'mb-10 mt-3'}>
                              {navigationItem.data.link ? (
                                ...
                                <div className={'text-base font-medium text-white transition-all hover:text-white/80'}>
                                  {navigationItem.data.label}{' '}
                                </div>
                              )}
                            </div>
                          ...
                          <>
                            <div className={'mb-10 mt-3'}>
                              {navigationItem.data?.link?.text ? (
                                <PrismicNextLink
                                  field={navigationItem.data.link}
                                  className="text-base font-medium text-white transition-all hover:text-white/80"></PrismicNextLink>
                              ) : (
                                <span
                                  className={
                                    'className="text-base hover:text-white/80" font-medium text-white transition-all'
                                  }>
                                  {navigationItem.data.label}
                                </span>
                              )}
            ...
            <div
              className={
                'flex flex-col items-center justify-center pb-10 md:flex-row md:justify-between md:space-x-5 md:py-10'
              }>
              <div className={'mx-auto md:mx-0'}>
                {!settings.google_widget && settings.google_rating && (
                  <PrismicNextImage field={settings.google_rating} />
                )}
