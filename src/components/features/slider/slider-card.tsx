...
export function SliderCard<T>({
  ...
  return (
      <div
          ...
          className={cn(
              "relative bg-secondary flex shrink-0 snap-start scroll-ml-[var(--scroll-padding)] flex-col justify-end overflow-hidden rounded-3xl max-lg:rounded-4xl lg:rounded-4xl",
              sizeClasses,
              className
          )}
      >
