 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ConditionDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<ConditionDocumentData>, "condition", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ConditionCategoryDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<ConditionCategoryDocumentData>, "condition_category", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type ConditionsDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<Simplify<ConditionsDocumentData>, "conditions", Lang>;
...
type GuideDocumentDataSlicesSlice = ListSlice | VerticalStepsWithImagesSlice | CaseStudiesSlice | TestimonialSlice | SoleDeconstructSlice | ReviewsSlice | FaqsSlice | MediaSectionSlice | SectionSlice | IconNavListSlice | CallToActionSlice
...
interface GuideDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	author: ContentRelationshipFieldWithData<[{"id":"author","fields":["name","link","description","profile_image"]}]>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type GuideDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<GuideDocumentData>, "guide", Lang>;

type HomeDocumentDataSlicesSlice = CaseStudiesSlice | ListSlice | MediaSectionSlice | SectionSlice | HeroSlice | TestimonialSlice | FaqsSlice | CallToActionSlice
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type MakeBookingDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<Simplify<MakeBookingDocumentData>, "make_booking", Lang>;
...
export interface NavigationBarDocumentDataNavigationItemsItem {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	navigation_item: prismic.ContentRelationshipField<"navigation_element"> | prismic.ContentRelationshipField<"navigation_mega_menu_item">;
}
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type NavigationBarDocument<Lang extends string = string> = prismic.PrismicDocumentWithoutUID<Simplify<NavigationBarDocumentData>, "navigation_bar", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type NavigationMegaMenuItemDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<NavigationMegaMenuItemDocumentData>, "navigation_mega_menu_item", Lang>;

type OrthoticsDocumentDataSlicesSlice = IconNavListSlice | ListSlice | MediaSectionSlice | ReviewsSlice | SoleDeconstructSlice | FaqsSlice | CallToActionSlice | SectionSlice | TestimonialSlice | HeroSlice
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type OrthoticsDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<OrthoticsDocumentData>, "orthotics", Lang>;

type PageDocumentDataSlicesSlice = ContactFormSectionSlice | ReviewsSlice | LocationMapCalloutSlice | VerticalStepsWithImagesSlice | CaseStudiesSlice | TestimonialsSlice | TimelineSlice | IconNavListSlice | TeamCarouselSlice | MediaSectionSlice | ListSlice | SectionSlice | TestimonialSlice | HeroSlice | CallToActionSlice | FaqsSlice
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PostTagsDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<PostTagsDocumentData>, "post_tags", Lang>;
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type PostsDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<PostsDocumentData>, "posts", Lang>;

type ServicesDocumentDataSlicesSlice = SoleDeconstructSlice | ReviewsSlice | CaseStudiesSlice | IconNavListSlice | MediaSectionSlice | ListSlice | CallToActionSlice | VerticalStepsWithImagesSlice | FaqsSlice | SectionSlice
...
type TreatmentDocumentDataSlicesSlice = ListSlice | SectionSlice | VerticalStepsWithImagesSlice | MediaSectionSlice | SoleDeconstructSlice | TestimonialSlice | TimelineSlice | TestimonialsSlice | ReviewsSlice | IconNavListSlice | FaqsSlice | CaseStudiesSlice | CallToActionSlice
...
interface TreatmentDocumentData {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/content-relationship
	 */
	service: ContentRelationshipFieldWithData<[{"id":"services","fields":["heading",{"id":"category","customtypes":[{"id":"post_category","fields":["name"]}]}]}]>;
...
export interface CallToActionSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	links: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary" | "Outline">>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceEmbedVideo = prismic.SharedSliceVariation<"embedVideo", Simplify<CallToActionSliceEmbedVideoPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CallToActionSliceCtaTwoColumns = prismic.SharedSliceVariation<"ctaTwoColumns", Simplify<CallToActionSliceCtaTwoColumnsPrimary>, never>;

/**
 * Slice variation for *CallToAction*
 */
type CallToActionSliceVariation = CallToActionSliceDefault | CallToActionSliceEmbedVideo | CallToActionSliceCtaTwoColumns
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type CaseStudiesSliceBento = prismic.SharedSliceVariation<"bento", Simplify<CaseStudiesSliceBentoPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContactFormSectionSliceDefault = prismic.SharedSliceVariation<"default", Simplify<ContactFormSectionSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ContactFormSectionSliceBookingForm = prismic.SharedSliceVariation<"bookingForm", Simplify<ContactFormSectionSliceBookingFormPrimary>, never>;
...
export interface FaqsSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	cta_links: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary" | "Accent">>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FaqsSliceColumnCollapsible = prismic.SharedSliceVariation<"columnCollapsible", Simplify<FaqsSliceColumnCollapsiblePrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type HeroSliceHeroMaster = prismic.SharedSliceVariation<"heroMaster", Simplify<HeroSliceHeroMasterPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type IconNavListSliceDefault = prismic.SharedSliceVariation<"default", Simplify<IconNavListSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type IconNavListSliceLogoTicker = prismic.SharedSliceVariation<"logoTicker", Simplify<IconNavListSliceLogoTickerPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type ListSlicePricingTable = prismic.SharedSliceVariation<"pricingTable", Simplify<ListSlicePricingTablePrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type LocationMapCalloutSliceMapWithCalloutRight = prismic.SharedSliceVariation<"map_with_callout_right", Simplify<LocationMapCalloutSliceMapWithCalloutRightPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MediaSectionSliceDefault = prismic.SharedSliceVariation<"default", Simplify<MediaSectionSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MediaSectionSliceFullWidthImage = prismic.SharedSliceVariation<"fullWidthImage", Simplify<MediaSectionSliceFullWidthImagePrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MediaSectionSliceSectionVideo = prismic.SharedSliceVariation<"sectionVideo", Simplify<MediaSectionSliceSectionVideoPrimary>, never>;

/**
 * Slice variation for *MediaSection*
 */
type MediaSectionSliceVariation = MediaSectionSliceDefault | MediaSectionSliceFullWidthImage | MediaSectionSliceSectionVideo
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MegamenuSliceDefault = prismic.SharedSliceVariation<"default", Simplify<MegamenuSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MegamenuSliceMegaVideo = prismic.SharedSliceVariation<"megaVideo", Simplify<MegamenuSliceMegaVideoPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type MegamenuSliceImageButtonRow = prismic.SharedSliceVariation<"imageButtonRow", Simplify<MegamenuSliceImageButtonRowPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentWithLeadButtons = prismic.SharedSliceVariation<"contentWithLeadButtons", Simplify<SectionSliceContentWithLeadButtonsPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentWithImageColumn = prismic.SharedSliceVariation<"contentWithImageColumn", Simplify<SectionSliceContentWithImageColumnPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentWithImageColumnList = prismic.SharedSliceVariation<"contentWithImageColumnList", Simplify<SectionSliceContentWithImageColumnListPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentWithImageFull = prismic.SharedSliceVariation<"contentWithImageFull", Simplify<SectionSliceContentWithImageFullPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentImageFloatText = prismic.SharedSliceVariation<"contentImageFloatText", Simplify<SectionSliceContentImageFloatTextPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentImageFloatRight = prismic.SharedSliceVariation<"contentImageFloatRight", Simplify<SectionSliceContentImageFloatRightPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentImageTwoColumns = prismic.SharedSliceVariation<"contentImageTwoColumns", Simplify<SectionSliceContentImageTwoColumnsPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentTwoColumnIconList = prismic.SharedSliceVariation<"contentTwoColumnIconList", Simplify<SectionSliceContentTwoColumnIconListPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentNoImageColumn = prismic.SharedSliceVariation<"contentNoImageColumn", Simplify<SectionSliceContentNoImageColumnPrimary>, never>;
...
export interface SectionSliceContentWithImageLeftRightPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	links: prismic.Repeatable<prismic.LinkField<string, string, unknown, prismic.FieldState, "Primary" | "Secondary" | "Accent" | "Outline" | "Link">>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentWithImageLeftRight = prismic.SharedSliceVariation<"contentWithImageLeftRight", Simplify<SectionSliceContentWithImageLeftRightPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SectionSliceContentColumnList = prismic.SharedSliceVariation<"contentColumnList", Simplify<SectionSliceContentColumnListPrimary>, never>;

/**
 * Slice variation for *Section*
 */
type SectionSliceVariation = SectionSliceDefault | SectionSliceContentWithLeadButtons | SectionSliceContentWithImageColumn | SectionSliceContentWithImageColumnList | SectionSliceContentWithImageFull | SectionSliceContentImageFloatText | SectionSliceContentImageFloatRight | SectionSliceContentImageTwoColumns | SectionSliceContentTwoColumnIconList | SectionSliceContentNoImageColumn | SectionSliceContentWithImageLeftRight | SectionSliceContentColumnList
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type SoleDeconstructSliceDefault = prismic.SharedSliceVariation<"default", Simplify<SoleDeconstructSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TeamCarouselSliceDefault = prismic.SharedSliceVariation<"default", Simplify<TeamCarouselSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type TimelineSliceVerticalWithImages = prismic.SharedSliceVariation<"vertical_with_images", Simplify<TimelineSliceVerticalWithImagesPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type VerticalStepsWithImagesSliceDefault = prismic.SharedSliceVariation<"default", Simplify<VerticalStepsWithImagesSliceDefaultPrimary>, never>;
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type VerticalStepsWithImagesSliceVideoVerticalStepper = prismic.SharedSliceVariation<"videoVerticalStepper", Simplify<VerticalStepsWithImagesSliceVideoVerticalStepperPrimary>, never>;

/**
 * Slice variation for *VerticalStepsWithImages*
 */
type VerticalStepsWithImagesSliceVariation = VerticalStepsWithImagesSliceDefault | VerticalStepsWithImagesSliceVideoVerticalStepper
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type VerticalStepsWithImagesSlice = prismic.SharedSlice<"vertical_steps_with_images", VerticalStepsWithImagesSliceVariation>;
