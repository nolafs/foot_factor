...
var fetchPosts = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(DOMAIN, "/wp-json/wp/v2/posts?per_page=100"), {
...
posts.forEach(function (post) { return __awaiter(void 0, void 0, void 0, function () {
    var slug, redirect, toml;
    return __generator(this, function (_a) {
        slug = post.slug;
        redirect = "/".concat(slug, "/ /blog/").concat(slug, " \n");
        // Append redirect to file
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        fs.appendFileSync('./migration/_redirects', redirect, function (err) {
            if (err) {
        ...
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        fs.appendFileSync('./migration/_redirects.toml', toml, function (err) {
            if (err) {
                console.error('Error writing to file:', err);
            }
        });
